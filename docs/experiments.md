...
| [Measuring OSM conversion constants against MaStR](results/germany.md#what-an-osm-solar-polygon-is-actually-worth-and-what-that-did-not-fix) | <span class="outcome mixed">partial</span> | Ground measures 0.081 against an assumed 0.050 (too LOW, not high); 73% of OSM ground area has no registered unit and 0% above 5 km<sup>2</sup>. Changes no published number. |
