...
# Self-contained: style, logo and markup, so a template adopts the badge by dropping in one
# `__VALIDATION_BADGE__` placeholder and never a copy of the CSS or an image path. The mark
# is the EarthPV logo carried as a data URI and drawn through a CSS mask, so it takes the
# tier colour and needs no file next to the page -- these atlases are standalone HTML that
# also get embedded in iframes and screenshotted from a staging directory, where a relative
# image path would break in at least one of the three.
_VSCORE_LOGO = "data:image/png;base64,"

CONTRIBUTE_URL = "https://open-energy-transition.github.io/earthpv/contribute/"
...
/* LIGHT PALETTE. The metals above are tuned for the dark page and silver in particular is
   near-white: measured at 1.03 contrast against the light panel, i.e. invisible. These
   override under BOTH of the page's own light selectors -- the media query for the system
   default and the explicit attribute for the in-page toggle -- so the badge follows the
   theme in either direction. Measured on the light panel: disc contrast 3.7 gold, 4.8
   silver, 5.7 bronze; tier text 5.1, 6.5, 7.0. */
:root[data-theme="light"] .vscore--gold {
  --vs: #a9760a; --vs-hi: #d8a53c; --vs-lo: #7d5405; --vs-ink: #fff8e6;
  --vs-text: #8a6108; --vs-ring: rgba(169,118,10,0.45); --vs-bg: rgba(169,118,10,0.09);
  --vs-rim: rgba(169,118,10,0.38); }
:root[data-theme="light"] .vscore--silver {
  --vs: #5f6e82; --vs-hi: #93a2b5; --vs-lo: #414c5b; --vs-ink: #ffffff;
  --vs-text: #4d5a6b; --vs-ring: rgba(95,110,130,0.45); --vs-bg: rgba(95,110,130,0.09);
  --vs-rim: rgba(95,110,130,0.36); }
:root[data-theme="light"] .vscore--bronze {
  --vs: #9c4a14; --vs-hi: #cf7a3f; --vs-lo: #6f3209; --vs-ink: #fdeade;
  --vs-text: #8a3f10; --vs-ring: rgba(156,74,20,0.48); --vs-bg: rgba(156,74,20,0.10);
  --vs-rim: rgba(156,74,20,0.40); }
@media (prefers-color-scheme: light) {
  :root:not([data-theme="dark"]) .vscore--gold {
    --vs: #a9760a; --vs-hi: #d8a53c; --vs-lo: #7d5405; --vs-ink: #fff8e6;
    --vs-text: #8a6108; --vs-ring: rgba(169,118,10,0.45); --vs-bg: rgba(169,118,10,0.09);
    --vs-rim: rgba(169,118,10,0.38); }
  :root:not([data-theme="dark"]) .vscore--silver {
    --vs: #5f6e82; --vs-hi: #93a2b5; --vs-lo: #414c5b; --vs-ink: #ffffff;
    --vs-text: #4d5a6b; --vs-ring: rgba(95,110,130,0.45); --vs-bg: rgba(95,110,130,0.09);
    --vs-rim: rgba(95,110,130,0.36); }
  :root:not([data-theme="dark"]) .vscore--bronze {
    --vs: #9c4a14; --vs-hi: #cf7a3f; --vs-lo: #6f3209; --vs-ink: #fdeade;
    --vs-text: #8a3f10; --vs-ring: rgba(156,74,20,0.48); --vs-bg: rgba(156,74,20,0.10);
    --vs-rim: rgba(156,74,20,0.40); }
}
...
def validation_badge_html(score: str) -> str:
    """The corner stamp: style, logo and markup in one self-contained block.

    Silver and Bronze carry a link to the contribution guide, because for those two the
    missing piece is local ground truth and a reader who cares about the score is exactly
    the person who could supply it.
    """
    ...
    name = VALIDATION_TIERS[key][0]
    cta = ("" if key == "gold" else
           '<span class="vscore-cta">Add local training data &rarr;</span>')
    tag, href = ("a", f' href="{CONTRIBUTE_URL}" target="_blank" rel="noopener"') \
        if key != "gold" else ("div", "")
