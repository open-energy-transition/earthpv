    ...
    **`downloads` / `data_release_url` (added 2026-08-14): a Downloads section linking to a
    ...
    for key, value in {
        ...
        "__CONFIDENCE_HTML__": (
            ...
            "quadrats and move together; and, for the small-PV contribution in cells with "
            "no nearby calibration at all, an explicit and deliberately wide allowance for "
            ...
            "the measured precision downward and the measured recall upward by an unknown "
            "amount &mdash; both in the direction that makes this page's figure a floor "
            "rather than a ceiling.</p>"
